...
ram_depth = int(config['DMVMKQCIM']['ArraySize'])
DigitRef3 = config['DMVMKQCIM']['DigitRef3']
DigitRef2 = config['DMVMKQCIM']['DigitRef2']
gmin_cancel = config['DMVMKQDevice']['gmincancel']

hardware = config['Quantization']['hardware']
# mixedsignal = config['DMVMKQCIM']['MixedSignal']
cellprecision       = int(config['DMVMKQCIM']['cellprecision'])
cycleprecision      = int(config['DMVMKQCIM']['cycleprecision'])
# cell_precision = int(config['DMVMCIM']['cellprecision'])
resmap  = config['DMVMKQDevice']['resmap']
with_cellvar = config['DMVMKQCIM']['WithCellVar']

adc_mode = config['DMVMKQADC']['mode']   
share_column = int(config['DMVMKQADC']['share'])
DumpData = config['DMVMKQADC']['dumpdata']
if adc_mode == 'Linear':
    RefFile =  config['DMVMKQADC']['linear_file']
elif adc_mode == 'NLinear':
    RefFile =  config['DMVMKQADC']['nlinear_file']
