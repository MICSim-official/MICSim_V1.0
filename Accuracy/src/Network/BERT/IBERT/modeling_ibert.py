...
from transformers.models.ibert.configuration_ibert import IBertConfig
...
class IBertSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        self.softmax = IntSoftmax(self.act_bit, quant_mode=self.quant_mode, force_dequant=force_dequant)
...
class IBertPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (QLinear, nn.Linear)):
