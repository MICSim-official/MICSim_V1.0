import numpy as np
import neurosim
from Performance.src.speedup.NM.PE import PE
...
class Tile():
    ...
    def CalculatePerformance(self,average_activityRowRead,input,inputshift,average_Condutance,weight,weight_n,average_dummy_conductance,speedup):
        #input is the int input array, in the nm mode, it has the shape [B,Fin,H*W]
        #weight is the digit weight array, in the nm mode, it has the shape [Fout,Fin,k1,k2]
